...
export const COMMANDS = {
  ...
  generateImage: {
    ...
    options: [
      ...
      { type: 4, name: 'height', description: '圖片高度', required: false, min_value: 256, max_value: 2048 },
      { type: 4, name: 'width', description: '圖片寬度', required: false, min_value: 256, max_value: 2048 },
      { type: 4, name: 'num_steps', description: '生成步數', required: false, min_value: 1, max_value: 20 },
    ],
  },
};
